...
# Touch NULL configs.
for useless_product_sysconfigs in 'pixel_2019_exclusive.xml' 'pixel_experience_2024.xml' 'pixel_experience_2019_midyear.xml' 'pixel_experience_2020.xml' 'pixel_experience_2020_midyear.xml' 'pixel_experience_2021.xml' 'pixel_experience_2021_midyear.xml' 'pixel_experience_2022.xml' 'pixel_experience_2023.xml' 'pixel_experience_2023_midyear.xml'; do
...
<?xml version="1.0" encoding="utf-8"?>
	<!-- autogenerated by ./src/misc/scripts/rom_modifier_scripts/addUnlimitedPhotosBackup.sh -->
...
cat >> ${PRODUCT_DIR}/etc/sysconfig/pixel_experience_tsukikacore.xml << EOF
<?xml version="1.0" encoding="utf-8"?>
<!-- autogenerated by ./src/misc/scripts/rom_modifier_scripts/addUnlimitedPhotosBackup.sh -->
<!-- These are configurations that should exist on all Tsukika devices. -->
<config>
...
# give perms:
for fileI in ${PRODUCT_DIR}/etc/sysconfig/pixel_2016_exclusive.xml ${PRODUCT_DIR}/etc/sysconfig/pixel_2017_exclusive.xml ${PRODUCT_DIR}/etc/sysconfig/pixel_2018_exclusive.xml \
    ${PRODUCT_DIR}/etc/sysconfig/pixel_experience_2019.xml ${PRODUCT_DIR}/etc/sysconfig/pixel_experience_tsukikacore.xml ${PRODUCT_DIR}/etc/sysconfig/pixel_2019_exclusive.xml \
