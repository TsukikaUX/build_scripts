...
- **TARGET_ADD_ROUNDED_CORNERS_TO_THE_PIP_WINDOWS**: [Adds rounded corners to the PiP window.](https://github.com/ikuyo-kita07/banners/blob/main/rounded_corners_tsukika_ex.png)
- **TARGET_BUILD_FIX_ANDROID_SYSTEM_DEVICE_WARNING**: Removes Android system warning.
- **TARGET_BUILD_ADD_DEPRECATED_UNICA_UPDATER**: Adds the deprecated UN1CA Updater app. [How to set it up?](https://github.com/ikuyo-kita07/Tsukika/blob/main/updaterConfigs/a30/README.md) (Fill `TARGET_BUILD_UNICA_UPDATER_OTA_MANIFEST_URL` variable. 29 is the least supported.)
